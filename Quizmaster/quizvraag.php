...
<main>
    <div class="quiz-button-container">
        <button class="quiz-green" data-form="../Quizvraag/quizvraagtoevoegenquizmaster.html">Quizvraag toevoegen</button>
        <button class="quiz-red" data-form="../Quizvraag/quizvraagverwijderenquizmaster.html">Quizvraag verwijderen</button>
    </div>
</main>
