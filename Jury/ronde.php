...
<head>
    ...
    <link rel="stylesheet" href="ronde.css">
...
<main>
    <div class="ronde-button-container">
        <button class="ronde-red" data-form="../Ronde/rondeverwijderenjury.html">Ronde verwijderen</button>
    </div>
